...
def filecompare(file_path, save_path):
    ...
    f1 = open(orginal_file1,'rb')
    f2 = open(orginal_file2,'rb')
...
if __name__ == "__main__":
    open_path = 'D:\\D盘桌面\\z江宝山\\联系data'          # 目标数据文件路径
    save_path = 'D:\\D盘桌面\\z江宝山\\联系data'       # 目标存储文件路径
